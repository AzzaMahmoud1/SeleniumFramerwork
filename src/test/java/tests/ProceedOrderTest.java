...
public class ProceedOrderTest extends TestBase {
	...
	public void createNewUserSuccessfully() {
		...
		CreateAccountObject.CreateNewAccount("testaz93825@test.com");
}
	...
	//	System.out.println(OrderPageObject.sectionTxt.getText());
