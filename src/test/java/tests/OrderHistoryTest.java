...
public class OrderHistoryTest extends TestBase {
	...
	public void createNewUserSuccessfully() {
		...
		CreateAccountObject.CreateNewAccount("testaz1397@test.com");
}
	...
	public void orderHistory(){
		...
		DashBoardPageObject.gotoHistoryPage();
		Assert.assertTrue(OrderPageObject.orderReferenceNum.contains(OrderHistoryPageObject.orderHistory.getText()));
	}
}
